...
```{r "mapview1", echo=TRUE, eval=TRUE, fig.align="center", fig.width=6, fig.height=6, out.width="100%", warning=FALSE}
library(mapview)
...
# Interactive map with `mapview`
```{r "mapview2", echo=TRUE, eval=TRUE, fig.align="center", fig.width=6, fig.height=6, out.width="100%", warning=FALSE}
covariates %>% 
