...
# Interactive map with `mapview` 1/2
...
# Interactive map with `mapview` 2/2
```{r message = FALSE, warning = FALSE, paged.print = FALSE, fig.align = 'center',fig.dim = c(15, 7), dpi = 300, eval = FALSE}
covariates %>% mutate(forestcover = as.numeric(forestcover)) %>% mapview(zcol = "forestcover", map.types = "OpenTopoMap") 
